...
function About() {
  ...
  const eboard = [
    ...
    { name: 'William Ostling', title: 'Chief Mechanical Engineer', image: `${process.env.PUBLIC_URL}/headshots/William.jpg` },
    { name: 'Luke Early', title: 'Chief Electrical Engineer', image: `${process.env.PUBLIC_URL}/headshots/Preindl.jpg` },
    { name: 'Tiller Van Doren', title: 'Chief Manufacturing Engineer', image: `${process.env.PUBLIC_URL}/headshots/Browne.jpg` },
    { name: 'Ricardo Victorio', title: 'Vehicle Dynamics Chief', image: `${process.env.PUBLIC_URL}/headshots/Ricardo.jpg` },
    { name: 'Samad Sulyman', title: 'Powertrain Chief', image: `${process.env.PUBLIC_URL}/headshots/Browne.jpg` },
    { name: 'Rogelio Sada', title: 'Controls Chief', image: `${process.env.PUBLIC_URL}/headshots/Rogelio.jpg` },
    { name: 'Lan Huse', title: 'High Voltage Chief', image: `${process.env.PUBLIC_URL}/headshots/Preindl.jpg` },
    { name: 'Sarah Hagan', title: 'Low Voltage Chief', image: `${process.env.PUBLIC_URL}/headshots/Sarah.jpg` },
    { name: 'Martin Lyubomirov Lozanov', title: 'Frame/Body/Aero Chief', image: `${process.env.PUBLIC_URL}/headshots/Browne.jpg` },
    ...
    { name: 'Kate Zhu', title: 'Secretary', image: `${process.env.PUBLIC_URL}/headshots/Kate.png` },
    { name: 'Ava Markwick', title: 'Social Chair', image: `${process.env.PUBLIC_URL}/headshots/Browne.jpg` },
  ];
