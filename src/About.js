...
function About() {
  ...
  const eboard = [
    ...
    { name: 'Tiller Van Doren', title: 'Chief Manufacturing Engineer', image: `${process.env.PUBLIC_URL}/headshots/Tiller.png` },
    ...
    { name: 'Martin Lyubomirov Lozanov', title: 'Frame/Body/Aero Chief', image: `${process.env.PUBLIC_URL}/headshots/Godwill.jpg` },
    ...
    { name: 'Ava Markwick', title: 'Social Chair', image: `${process.env.PUBLIC_URL}/headshots/Ava.png` },
  ];
