...
const sponsors = [
  ...
  { name: 'Cascadia Motion', url: 'https://www.cascadiamotion.com', image: `${process.env.PUBLIC_URL}/sponsors/cascadiamotion.png` },
  ...
  { name: 'Haas', url: 'https://www.haascnc.com', image: `${process.env.PUBLIC_URL}/sponsors/haas.png` },
  ...
  { name: 'SimScale', url: 'https://www.simscale.com/', image: `${process.env.PUBLIC_URL}/sponsors/simscale.png` },
